  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <section class="container m-auto mt-32">
        <h1 class="text-6xl font-semibold">你好，我是<span className="text-orange-500">鄧登举</span>,</h1>
        ...
        <div class="flex pt-2">
          ...
          {/* <div class="ml-4 flex cursor-pointer bg-transparent text-orange-500 font-semibold hover:text-orange-600 p-2 rounded-full transition duration-150">
      ...
      <section 
        ...
        <div class="w-1/2 pr-8">
          <h2 class="text-4xl"><span className="text-orange-500"># </span> 我的最大乐趣是开发自己</h2>
      ...
      <section class="container m-auto">
        <h2 class="text-4xl"><span className="text-orange-500">#</span> 擅于使用工具提升工作效率</h2>
